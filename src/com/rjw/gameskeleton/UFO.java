...
public class UFO extends Thing{
	...
	static final int UFO_TEST_SIZE = 32;
	static final int UFO_HEALTH = 50;
	...
	public UFO(int x, int y, int vx, int vy){
		...
		super(ThingManager.THING_ID_UFO, x, y, UFO_TEST_SIZE, UFO_TEST_SIZE, new Animation(), new Animation(), new Animation());
		...
		try{	
			_frameTile = ImageIO.read(new File(OtherStuff.SPRITE_PATH_PREFIX + OtherStuff.SPRITE_UFO));
			_effectsTile = ImageIO.read(new File(OtherStuff.SPRITE_PATH_PREFIX + OtherStuff.SPRITE_EFFECTS_001));
		}catch(Exception e){
			GameSkeleton.printDebugMessage("error loading frames for UFO ("+e.getMessage()+")");
		}
		...
		super.addAnimFrame(_frameTile.getSubimage(64, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(96, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(128, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(160, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(192, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(224, 0, 32, 32), 300);
		super.addAnimFrame(_frameTile.getSubimage(256, 0, 32, 32), 300);
		...
		super.addEffectAnimFrame(_effectsTile.getSubimage(0,0,UFO_TEST_SIZE,UFO_TEST_SIZE), 0);
		...
		super.addEffectAnimFrame(_effectsTile.getSubimage(UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
		super.addEffectAnimFrame(_effectsTile.getSubimage(2*UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
		
		// and our dying effect
		super.addEffectAnimation(new Animation());
		super.setCurrentEffectAnimation(ANIM_EFFECT_DYING);
		super.addEffectAnimFrame(_effectsTile.getSubimage(3*UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
		super.addEffectAnimFrame(_effectsTile.getSubimage(4*UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
		super.addEffectAnimFrame(_effectsTile.getSubimage(5*UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
		super.addEffectAnimFrame(_effectsTile.getSubimage(6*UFO_TEST_SIZE,0,UFO_TEST_SIZE,UFO_TEST_SIZE),250);
	...
	public void process(long elapsedTime) {
		...
		//_soundPlayBackTimer3.update(elapsedTime);
